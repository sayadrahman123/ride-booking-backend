...
public class ReceiptResponse {
    ...
    private String humanReadableAmount; // e.g., "₹105.00"
    ...
    public String getHumanReadableAmount() { return humanReadableAmount; }
    public void setHumanReadableAmount(String humanReadableAmount) { this.humanReadableAmount = humanReadableAmount; }
}
